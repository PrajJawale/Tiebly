...
function Description() {
    ...
    // // Check if jobId is being fetched
    // console.log("Job ID from params:", jobId);  // Debugging log
        ...
        const fetchSingleJob = async () => {
            ...
            try {
                ...
                if (res.data.success) {
                    ...
                    setIsApplied(res.data.job.application.some(application => application.applicant === user?._id)); // Sync with fetched data
                }
            } catch (error) {
                console.log(error);
            }
            ...
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        <Badge className={'text-blue-700 font-bold'} variant="ghost">{singleJob?.positoon} Positions</Badge>
